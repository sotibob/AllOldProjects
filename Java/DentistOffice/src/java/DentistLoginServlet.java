...
public class DentistLoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            //New Dentist Object is created and the information is pulled from the database
            Dentist d1 = new Dentist();   
            d1.selectDB(id);   
            
            if(id.equals(d1.getID()) && password.equals(d1.getPassword())) //If the password and ID inputed matches any in the database
            {
                //New session is created and the Dentist Object is put into it
                HttpSession ses1;
